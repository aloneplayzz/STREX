  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, hsl(var(--primary) / 0.15) 0%, hsl(var(--purple) / 0.1) 50%, hsl(var(--cyan) / 0.05) 100%)",
      },
      boxShadow: {
        "glow-sm": "0 0 15px -3px hsl(var(--primary) / 0.3)",
        "glow": "0 0 25px -5px hsl(var(--primary) / 0.4)",
        "glow-lg": "0 0 40px -10px hsl(var(--primary) / 0.5)",
        "glow-cyan": "0 0 25px -5px hsl(var(--cyan) / 0.4)",
        "glow-purple": "0 0 25px -5px hsl(var(--purple) / 0.4)",
        "card-hover": "0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 30px -10px hsl(var(--primary) / 0.3)",
      },
    },
  },
